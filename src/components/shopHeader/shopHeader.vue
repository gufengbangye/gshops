  ...
  <div class="shop-header">
    ...
    <div class="shop-content" >
      ...
      <div class="header-content">
        <h2 class="content-title" @click="toggleShow=!toggleShow">
    ...
    <div class="shop-header-discounts" @click="toggleShowTip=!toggleShowTip" v-if="info.supports" >
   ...
   <transition name="fade">
        <div class="shop-brief-modal" v-show="toggleShow">
      <div class="brief-modal-content ">
        ...
        <div class="mask-footer" @click="toggleShow=!toggleShow">
   ...
   <transition name="fadeIn">
        <div class="activity-sheet" v-show="toggleShowTip">
      <div class="activity-sheet-content">
        <h2 class="activity-sheet-title">优惠活动</h2>
        <ul class="list" v-if="info.supports">
         <li v-for="(item,index) in info.supports" :key='index' class="activity-item" :class="activeColor[info.supports[index].type]">
             <span class="content-tag">
        ...
        <div class="activity-sheet-close" @click="toggleShowTip=!toggleShowTip">
          <span class="iconfont icon-close"></span>
        </div>
      </div>
