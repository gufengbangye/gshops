  ...
  <div class="shop-info">
    <div class="info-content">
      ...
      <section class="section">
        ...
        <div class="activity">
          <div class="activity-item " v-for="(suport,index) in info.supports" :key="index" :class="activeColor[suport.type]">
    ...
    info: {
      handler: function () {
        this.$nextTick(() => {
          ...
          let ul = this.$refs.ulList
          var space = 6
          var count = ul.children.length
          ul.style.width = (space + 120) * count -space + 'px'
